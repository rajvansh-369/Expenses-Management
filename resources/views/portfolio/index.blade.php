                    ...
                    <div class="art-info-bar-frame">
                        ...
                        <div class="art-header">
                            ...
                            <div class="art-avatar">
                                <a data-fancybox="avatar" data-no-swup href="{{ asset('img/face-1.jpg') }}"
                                            ...
                                            <div class="art-service-ib-content">
                                                ...
                                                <div class="skillIcons">
                                                    ...
                                                    <img class="full_screen"
                                                        ...
                                                        alt="">
                                                    <img class="mobile_screen"
                                                        src="https://skillicons.dev/icons?i=php,laravel,python,"
                                                        alt="">
                                                    <img class="mobile_screen"
                                                        src="https://skillicons.dev/icons?i=js,wordpress,jquery"
                                                        alt="">
                                                    <img class="mobile_screen"
                                                        src="https://skillicons.dev/icons?i=html,css,bootstrap"
                                                        alt="">
                                                    <img class="mobile_screen"
                                                        src="https://skillicons.dev/icons?i=mysql,git,arduino"
                                                        alt="">
                                                </div>
                                                <!-- text -->
                                                <div class="mb-15">
                                                    ...
                                                    <div class="art-a art-testimonial">
                                                        ...
                                                        <div class="testimonial-body">
                                                            ...
                                                            <img class="art-testimonial-face"
                                                                src="{{ asset('storage/img/testimonials/face-3.jpg') }}"
                                                                alt="face">
                                                            <!-- name -->
                                                            <h5>Paul Trueman</h5>
                                                ...
                                                <div class="art-recomendation-popup" style="display: none;"
                                                    ...
                                                    <div class="art-a art-testimonial">
                                                        ...
                                                        <div class="testimonial-body">
                                                            <!-- photo -->
                                                            <img class="art-testimonial-face"
                                                                src="{{ asset('storage/img/testimonials/face-4.jpg') }}"
                                                                alt="face">
                                                            <!-- name -->
                                                            <h5>Paul Trueman</h5>
                                                            <div class="art-el-suptitle mb-15">Template author</div>
                                        ...
                                        <div class="art-a art-card">
                                            ...
                                            <form id="form" class="art-contact-form">
                                                ...
                                                <div class="art-form-field">
                                                    <!-- name input -->
                                                    <input id="name" name="name" class="art-input"
                                                ...
                                                <div class="art-form-field">
                                                    <!-- email input -->
                                                    <input id="email" name="email" class="art-input"
